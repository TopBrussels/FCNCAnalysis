...
void InitMSPlots(string prefix, vector <int> decayChannels){
  ...
  for(int iChan =0; iChan < decayChannels.size() ; iChan++){
    ...
    if(decayChannels[iChan] == 0 || decayChannels[iChan] == 1 ){
    ...
    if(decayChannels[iChan] == 0 || decayChannels[iChan] == 1 || decayChannels[iChan] == 2){
    ...
    if(decayChannels[iChan]!=0){
      ...
      if(decayChannels[iChan] == 3 || decayChannels[iChan] == 2 ){
      ...
      if(decayChannels[iChan] == 3 || decayChannels[iChan] == 1 || decayChannels[iChan] == 2){
  ...
  for(int iChan =0; iChan < decayChannels.size() ; iChan++){
    ...
    if(decayChannels[iChan] != 0){
      ...
      for(int iter = 0; iter < selectedElectrons.size(); iter++){
        ...
        if(decayChannels[iChan] != 3){
      if(selectedMuons.size()>2 && decayhannels[iChan] == 0){
      ...
      if(selectedMuons.size()>1 && (decayhannels[iChan] == 0 || decayhannels[iChan] == 1)){
      ...
      if(selectedMuons.size()>0 && ( decayhannels[iChan] == 0 || decayhannels[iChan] == 1 || decayhannels[iChan] == 2)){
