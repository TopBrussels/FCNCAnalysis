...
//  vector<string> Vmyprocess = {"WZ","tZq","data"};
  ...
  for(unsigned int iVar = 0; iVar < listHisto.size(); iVar++)
  {
   ...
   if(plotData)
   {
    ...
    cout<< " Hello I am at 2 ----" << endl;
    h[iVar][datanb]->Draw("e,same");
    leg->AddEntry(h[iVar][datanb], Vmyprocess[datanb],"p");   
    cout<< " Hello I am at 3----" << endl;
    labelcms->Draw();
    labelcms2->Draw(); 
    leg->Draw(); 
    c1->cd(); 
 cout<< " Hello I am at 3 -1 ----" << endl;
    ...
    pad2->cd();
    hdata->Sumw2();
    cout<< " Hello I am at 3 -1 -1----" << endl;
    histo[iVar]->Divide(hdata);
    cout<< " Hello I am at 3-1 -2 ---" << endl;
    histo[iVar]->SetMarkerStyle(21);
    histo[iVar]->SetTitle("");
    cout<< " Hello I am at 3 1- 3----" << endl;
    histo[iVar]->GetXaxis()->SetTitle(listTitle[iVar].c_str());
    cout<< " Hello I am at 3 - 2----" << endl;
