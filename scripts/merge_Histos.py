...
runDate = "Test_Floatweights_26July17" # to be adapted to the date of analysis run
...
#tree = ET.ElementTree(file='../config/Run2SameSignDiLepton_80X_MuMu_V4_Samples.xml')
...
for n in datasetNames:
    ...
    for f in filenames:
        hadd = hadd + " " + f
    print "Merging Histograms for " + n
    os.system(hadd)
