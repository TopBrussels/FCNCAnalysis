...
string infile = "OutputPlots/170620_1629/NtuplePlots.root";//1543
string eclusiveinfile = "OutputPlots/170620_1629/NtuplePlots.root";
bool debug = false;
...
void Optimal_cut(){
  ...
  TFile *outputfile = new TFile("NtuplePlotsTest.root","RECREATE");
  
  vector <string> Variables;
		
  Variables.push_back("DeltaEtaWlepB3lep");
  Variables.push_back("DeltaEtaWlepZ3lep");
  Variables.push_back("DeltaEtaWlepSMtop3lep");
  Variables.push_back("d0muon3lep");
  Variables.push_back("d0electron3lep");
  Variables.push_back("d0all3lep");
  Variables.push_back("DeltaRWlepB3lep");
  Variables.push_back("DeltaRWlepZ3lep");
  Variables.push_back("DeltaRWlepSMtop3lep");
  ...
  backgroundnames.push_back("fake_80X");
  
  
  signalname.push_back("NP_overlay_ST_FCNC_zct_80X");
  ...
  for(unsigned int iVar = 0; iVar<Variables.size(); iVar++){
    ...
    string Path_To_Histo = "1D_histograms_fakedisc";
    ...
    for(unsigned int iBackgr = 0; iBackgr < backgroundnames.size(); iBackgr++){
      ...
      /*if(histo_exclusive){
        ...
        HistoBackground = histo_exclusive;
        first_index_B = iBackgr;
        Histo_samples.push_back(histo_exclusive);
        Name_samples.push_back(backgroundnames[iBackgr]);
    ...
    for(unsigned int i = 1; i< end; i++){
      ...
      double b = 0;
      //cout << i << endl;
      s = (HistoSignal->Integral(1 , i));
      b = (HistoBackground->Integral(1,i));
    ...
    */
    ...
    Histo_samples.clear();
    Name_samples.clear();
    cout << "done with " <<  Variables[iVar] << endl;
  }
