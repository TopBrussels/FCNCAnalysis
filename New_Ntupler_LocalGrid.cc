...
//    
    ...
    float oldLuminosity = 1622.084071651 ; //v10Golden //2163.382398567; //this for v8Golden and for v8 = 1263.885980236; //anaEnv.Luminosity;  // in 1/pb
...
//            {
//                
//                if(!isData) Elec_scaleFactor[nElectrons]=electronSFWeight_->at(selectedElectrons[selel]->Eta(),selectedElectrons[selel]->Pt(),0);
//                else Elec_scaleFactor[nElectrons] = 1.;
//                nElectrons++;
//            }
