...
dout="/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/"
...
-v dout=${dout},line2=${fpath}${line},fout=${fout},nToys=${nToys},isSig=${isSig},applyMVA=${applyMVA},nNonBJetMax=${nNonBJetMax},coup=${coup} 2>&1 | grep "Invalid credential") != "" ]];
