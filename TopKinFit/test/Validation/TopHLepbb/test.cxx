...
int main(int argc, char *argv[])
{
   ...
   std::string coup = std::string(argv[7]);
   ...
   if( applyMVA )
	...
	std::string weightsFileFullRecoTruth = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAFullReco"+coup+"Truth_BDT.weights.xml";
	...
	std::string weightsFileFullRecoAll = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAFullReco"+coup+"All_BDT.weights.xml";
	...
	std::string weightsFileFullRecoHighestCSVv2 = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAFullReco"+coup+"HighestCSVv2_BDT.weights.xml";
	...
	std::string weightsFileFullRecoCSVv2L = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAFullReco"+coup+"CSVv2L_BDT.weights.xml";
	...
	std::string weightsFileFullRecoCSVv2M = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAFullReco"+coup+"CSVv2M_BDT.weights.xml";
	...
	std::string weightsFileFullRecoCSVv2T = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAFullReco"+coup+"CSVv2T_BDT.weights.xml";
	...
	std::string weightsFilePartRecoTruth = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAPartReco"+coup+"Truth_BDT.weights.xml";
	...
	std::string weightsFilePartRecoAll = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAPartReco"+coup+"All_BDT.weights.xml";
	...
	std::string weightsFilePartRecoHighestCSVv2 = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAPartReco"+coup+"HighestCSVv2_BDT.weights.xml";
	...
	std::string weightsFilePartRecoCSVv2L = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAPartReco"+coup+"CSVv2L_BDT.weights.xml";
	...
	std::string weightsFilePartRecoCSVv2M = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAPartReco"+coup+"CSVv2M_BDT.weights.xml";
	...
	std::string weightsFilePartRecoCSVv2T = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/Validation/TopHLepbb/MVA/weights/TMVAPartReco"+coup+"CSVv2T_BDT.weights.xml";
   ...
   std::string pdfFileName = "/user/kskovpen/analysis/tHFCNC/CMSSW_8_0_25/src/TopKinFit/test/GenAnalysis/TopHLepbb/pdf.root";
   ...
   if( isSig )
	...
	std::vector<float> HiggsRecEtaTruth;
	std::vector<float> HiggsRecEtaAll;
	std::vector<float> HiggsRecEtaHighestCSVv2;
	std::vector<float> HiggsRecEtaCSVv2L;
	std::vector<float> HiggsRecEtaCSVv2M;
	std::vector<float> HiggsRecEtaCSVv2T;
	...
	trFIT->Branch("HiggsRecEtaTruth","std::vector<float>",&HiggsRecEtaTruth);
	trFIT->Branch("HiggsRecEtaAll","std::vector<float>",&HiggsRecEtaAll);
	trFIT->Branch("HiggsRecEtaHighestCSVv2","std::vector<float>",&HiggsRecEtaHighestCSVv2);
	trFIT->Branch("HiggsRecEtaCSVv2L","std::vector<float>",&HiggsRecEtaCSVv2L);
	trFIT->Branch("HiggsRecEtaCSVv2M","std::vector<float>",&HiggsRecEtaCSVv2M);
	trFIT->Branch("HiggsRecEtaCSVv2T","std::vector<float>",&HiggsRecEtaCSVv2T);
	...
	for(int i=0;i<nev;i++)
	  {
	     ...
	     HiggsRecEtaTruth.clear();
	     HiggsRecEtaAll.clear();
	     HiggsRecEtaHighestCSVv2.clear();
	     HiggsRecEtaCSVv2L.clear();
	     HiggsRecEtaCSVv2M.clear();
	     HiggsRecEtaCSVv2T.clear();
	     ...
	     for(int it=0;it<6;it++)
		  ...
		  if( it == 0 ) // Truth
		  ...
		  else if( it != 5 )
		    {
		       ...
		       JetCSVv2.push_back(std::make_pair(HiggsBJet1RecCSVv2,1));
		       JetCSVv2.push_back(std::make_pair(HiggsBJet2RecCSVv2,2));
		       
		       for(int ij=0;ij<OtherJetRecPt->size();ij++)
			 JetCSVv2.push_back(std::make_pair(OtherJetRecCSVv2->at(ij),3+ij));
			 ...
			 {		       	
			    ...
			    if( idx == 0 )
				 ...
				 if( ((nBJet < 3 && it == 1) || it > 1) && passBTag )
			      ...
			      {
				 bool passBTag = 1;
				 if( OtherJetRecCSVv2->at(idx-3) < CSVv2L && it == 2 ) passBTag = 0;
				 if( OtherJetRecCSVv2->at(idx-3) < CSVv2M && it == 3 ) passBTag = 0;
				 if( OtherJetRecCSVv2->at(idx-3) < CSVv2T && it == 4 ) passBTag = 0;
				 
				 if( ((nBJet < 3 && it == 1) || it > 1) && passBTag )
				   {
				      BJetPt.push_back(OtherJetRecPt->at(idx-3));
				      BJetEta.push_back(OtherJetRecEta->at(idx-3));
				      BJetPhi.push_back(OtherJetRecPhi->at(idx-3));
				      BJetE.push_back(OtherJetRecE->at(idx-3));
				      BJetCSVv2.push_back(OtherJetRecCSVv2->at(idx-3));
				   }
				 else
				   {
				      NonBJetPt.push_back(OtherJetRecPt->at(idx-3));
				      NonBJetEta.push_back(OtherJetRecEta->at(idx-3));
				      NonBJetPhi.push_back(OtherJetRecPhi->at(idx-3));
				      NonBJetE.push_back(OtherJetRecE->at(idx-3));
				      NonBJetCSVv2.push_back(OtherJetRecCSVv2->at(idx-3));
				   }
			      }		       
			 }		  
		    }
		  ...
		  if( BJetPt.size() < 3 ) continue;
		  if( it == 5 && BJetPt.size() < 3 ) continue;
		  ...
		  for(int ip=0;ip<NPerm;ip++)
		    {
		       ...
		       int idxTopLepWElecFit = kf->GetIndex(ELECTRON_TOPHLEPBB,ip);
		       int idxTopLepWMuonFit = kf->GetIndex(MUON_TOPHLEPBB,ip);
		       int idxTopLepBJetFit = kf->GetIndex(BJETLEP_TOPHLEPBB,ip);
		       int idxHiggsBJet1Fit = kf->GetIndex(BJET1_TOPHLEPBB,ip);
		       int idxHiggsBJet2Fit = kf->GetIndex(BJET2_TOPHLEPBB,ip);
			 ...
			 ((HiggsBJet2FitEta-HiggsBJet2RecEta < 10E-6 &&
		       ...
		       float VarHiggsRecEta = Higgs.PseudoRapidity();
		       ...
		       bool hasMatch = MatchTopLepBJet && MatchHiggsBJet1 && MatchHiggsBJet2;
		       ...
		       if( it == 0 ) 
			 {
			    ...
			    HiggsRecEtaTruth.push_back(VarHiggsRecEta);
		       ...
		       else if( it == 1 )
			 {
			    ...
			    HiggsRecEtaHighestCSVv2.push_back(VarHiggsRecEta);
		       ...
		       else if( it == 2 )
			 {
			    ...
			    HiggsRecEtaCSVv2L.push_back(VarHiggsRecEta);
		       ...
		       else if( it == 3 )			 
			 {
			    ...
			    HiggsRecEtaCSVv2M.push_back(VarHiggsRecEta);
		       ...
		       else if( it == 4 )
			 {
			    ...
			    HiggsRecEtaCSVv2T.push_back(VarHiggsRecEta);
		       ...
		       else if( it == 5 )
			 {
			    ...
			    HiggsRecEtaAll.push_back(VarHiggsRecEta);
