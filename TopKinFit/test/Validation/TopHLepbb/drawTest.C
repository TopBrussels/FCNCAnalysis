...
void drawTest()
{
   ...
   trFIT.Add("runSIG_MERGED/ST_TH_1L3B/data.root");
//   trFIT.Add("runSIG_MERGED/ST_TH_1L3B_Hct/data.root");

   TChain trEFF("trEFF");

   trEFF.Add("runSIG_MERGED/ST_TH_1L3B/data.root");
//   trEFF.Add("runSIG_MERGED/ST_TH_1L3B_Hct/data.root");
