...
echo "Executing ./test ${line2} ${dout}${fout} ${nToys} ${isSig} ${applyMVA} ${nNonBJetMax} ${coup}"
#${dout}/./test ${line2} ${dout}${fout} ${nToys} > /dev/null
${dout}/./test ${line2} ${dout}${fout} ${nToys} ${isSig} ${applyMVA} ${nNonBJetMax} ${coup}
