...
int main(int argc, char *argv[])
{
   ...
   // Truth
     {
	std::string FileName = "TMVAFullReco"+coup+"Truth.root";
	...
	std::string MVAName = "TMVAFullReco"+coup+"Truth";
   ...
   // HighestCSVv2
     {	
	std::string FileName = "TMVAFullReco"+coup+"HighestCSVv2.root";
	...
	std::string MVAName = "TMVAFullReco"+coup+"HighestCSVv2";
   ...
   // CSVv2L
     {
	std::string FileName = "TMVAFullReco"+coup+"CSVv2L.root";
	...
	std::string MVAName = "TMVAFullReco"+coup+"CSVv2L";
   ...
   // CSVv2M
     {
	std::string FileName = "TMVAFullReco"+coup+"CSVv2M.root";
	...
	std::string MVAName = "TMVAFullReco"+coup+"CSVv2M";
   ...
   // CSVv2T
     {
	std::string FileName = "TMVAFullReco"+coup+"CSVv2T.root";
	...
	std::string MVAName = "TMVAFullReco"+coup+"CSVv2T";
   ...
   // All
     {
	std::string FileName = "TMVAFullReco"+coup+"All.root";
	...
	std::string MVAName = "TMVAFullReco"+coup+"All";
