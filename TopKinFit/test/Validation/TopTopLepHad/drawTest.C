...
void drawTest()
{
   ...
   trFIT.SetBranchAddress("TopHadRecPtTruth",&TopHadRecPtTruth);
   ...
   hMatch[nHist] = new TH1D("h_TopHadRecMTruthMatch","h_TopHadRecMTruthMatch",30,0.,500.);
   hMatch[nHist]->Sumw2();
   hNotMatch[nHist] = new TH1D("h_TopHadRecMTruthNotMatch","h_TopHadRecMTruthNotMatch",30,0.,500.);
   hNotMatch[nHist]->Sumw2();
   hName[nHist] = "TopHadRecMTruth";
   ...
   hMatch[nHist] = new TH1D("h_TopLepTopHadRecDrTruthMatch","h_TopLepTopHadRecDrTruthMatch",30,0.,5.);
   hMatch[nHist]->Sumw2();
   hNotMatch[nHist] = new TH1D("h_TopLepTopHadRecDrTruthNotMatch","h_TopLepTopHadRecDrTruthNotMatch",30,0.,5.);
   hNotMatch[nHist]->Sumw2();
   hName[nHist] = "TopLepTopHadRecDrTruth";
   ...
   hMatch[nHist] = new TH1D("h_TopHadRecPtTruthMatch","h_TopHadRecPtTruthMatch",30,0.,250.);
   hMatch[nHist]->Sumw2();
   hNotMatch[nHist] = new TH1D("h_TopHadRecPtTruthNotMatch","h_TopHadRecPtTruthNotMatch",30,0.,250.);
   hNotMatch[nHist]->Sumw2();
   hName[nHist] = "TopHadRecPtTruth";
   ...
   hMatch[nHist] = new TH1D("h_TopLepTopHadRecDphiTTruthMatch","h_TopLepTopHadRecDphiTTruthMatch",30,-5.,5.);
   hMatch[nHist]->Sumw2();
   hNotMatch[nHist] = new TH1D("h_TopLepTopHadRecDphiTTruthNotMatch","h_TopLepTopHadRecDphiTTruthNotMatch",30,-5.,5.);
   hNotMatch[nHist]->Sumw2();
   hName[nHist] = "TopLepTopHadRecDphiTTruth";
		  ...
		  if( DiscTruth->at(ip) < 10E+10 )
		    {
		       if( hName[ih] == "DiscTruth" )
			 {
		       ...
		       else if( hName[ih] == "TopHadRecMTruth" )
			 {
			    if( MatchTruth->at(ip) ) hMatch[ih]->Fill(TopHadRecMTruth->at(ip));
			    else hNotMatch[ih]->Fill(TopHadRecMTruth->at(ip));
			 }
		       else if( hName[ih] == "TopLepRecMTruth" )
			 {
		       ...
		       else if( hName[ih] == "TopLepTopHadRecDrTruth" )
			 {
			    if( MatchTruth->at(ip) ) hMatch[ih]->Fill(TopLepTopHadRecDrTruth->at(ip));
			    else hNotMatch[ih]->Fill(TopLepTopHadRecDrTruth->at(ip));
			 }
		       else if( hName[ih] == "TopLepRecPtTruth" )
			 {
		       ...
		       else if( hName[ih] == "TopHadRecPtTruth" )
			 {
			    if( MatchTruth->at(ip) ) hMatch[ih]->Fill(TopHadRecPtTruth->at(ip));
			    else hNotMatch[ih]->Fill(TopHadRecPtTruth->at(ip));
			 }
		       else if( hName[ih] == "TopLepRecMTTruth" )
			 {
		       ...
		       else if( hName[ih] == "TopLepTopHadRecDphiTTruth" )
			 {
			    if( MatchTruth->at(ip) ) hMatch[ih]->Fill(TopLepTopHadRecDphiTTruth->at(ip));
			    else hNotMatch[ih]->Fill(TopLepTopHadRecDphiTTruth->at(ip));
			 }
	...
	for(int ih=0;ih<nHistFit;ih++)
	  {
	     ...
	     else if( hNameFit[ih] == "MVATopHadRecMTruthFit" )
	       {
		  hFit[ih]->Fill(MVATopHadRecMTruth->at(0));
	       }
