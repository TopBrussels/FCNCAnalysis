...
int main(int argc, char *argv[])
{
   ...
   float TopHadNonBJetPt, TopHadNonBJetEta, TopHadNonBJetPhi, TopHadNonBJetE;
   ...
   float dTopHadNonBJetPx, dTopHadNonBJetPy, dTopHadNonBJetPz, dTopHadNonBJetE;
   float dElecPx, dElecPy, dElecPz, dElecE;
   float dMuonPx, dMuonPy, dMuonPz, dMuonE;
   // Additional kinematic variables
   float HiggsBJet1HiggsBJet2Dr, HiggsTopLepWNuDr, HiggsTopLepWLepDr, HiggsTopHadNonBJetDr, TopLepWLepTopHadNonBJetDr;
   float TopLepTopHadDr, TopLepHiggsDr, TopHadHiggsDr, TopLepWTopLepBJetDr;
   ...
   trGEN->Branch("TopHadNonBJetPt",&TopHadNonBJetPt,"TopHadNonBJetPt/F");
   trGEN->Branch("TopHadNonBJetEta",&TopHadNonBJetEta,"TopHadNonBJetEta/F");
   trGEN->Branch("TopHadNonBJetPhi",&TopHadNonBJetPhi,"TopHadNonBJetPhi/F");
   trGEN->Branch("TopHadNonBJetE",&TopHadNonBJetE,"TopHadNonBJetE/F");
   ...
   trGEN->Branch("TopHadNonBJetRecPt",&TopHadNonBJetRecPt,"TopHadNonBJetRecPt/F");
   trGEN->Branch("TopHadNonBJetRecEta",&TopHadNonBJetRecEta,"TopHadNonBJetRecEta/F");
   trGEN->Branch("TopHadNonBJetRecPhi",&TopHadNonBJetRecPhi,"TopHadNonBJetRecPhi/F");
   trGEN->Branch("TopHadNonBJetRecE",&TopHadNonBJetRecE,"TopHadNonBJetRecE/F");
   trGEN->Branch("TopHadNonBJetRecCSVv2",&TopHadNonBJetRecCSVv2,"TopHadNonBJetRecCSVv2/F");
   ...
   trGEN->Branch("dTopHadNonBJetPx",&dTopHadNonBJetPx,"dTopHadNonBJetPx/F");
   trGEN->Branch("dTopHadNonBJetPy",&dTopHadNonBJetPy,"dTopHadNonBJetPy/F");
   trGEN->Branch("dTopHadNonBJetPz",&dTopHadNonBJetPz,"dTopHadNonBJetPz/F");
   trGEN->Branch("dTopHadNonBJetE",&dTopHadNonBJetE,"dTopHadNonBJetE/F");
   ...
   trGEN->Branch("HiggsTopHadNonBJetDr",&HiggsTopHadNonBJetDr,"HiggsTopHadNonBJetDr/F");
   trGEN->Branch("TopLepWLepTopHadNonBJetDr",&TopLepWLepTopHadNonBJetDr,"TopLepWLepTopHadNonBJetDr/F");
   trGEN->Branch("TopLepTopHadDr",&TopLepTopHadDr,"TopLepTopHadDr/F");
   trGEN->Branch("TopLepHiggsDr",&TopLepHiggsDr,"TopLepHiggsDr/F");
   trGEN->Branch("TopHadHiggsDr",&TopHadHiggsDr,"TopHadHiggsDr/F");
   ...
   for(int i=0;i<nev;i++)
	...
	TopHadNonBJetPt = NONE; TopHadNonBJetEta = NONE; TopHadNonBJetPhi = NONE; TopHadNonBJetE = NONE;
	...
	TopHadNonBJetRecPt = NONE; TopHadNonBJetRecEta = NONE; TopHadNonBJetRecPhi = NONE; TopHadNonBJetRecE = NONE; TopHadNonBJetRecCSVv2 = NONE;
	...
	dTopHadNonBJetPx = NONE; dTopHadNonBJetPy = NONE; dTopHadNonBJetPz = NONE; dTopHadNonBJetE = NONE;
	dElecPx; dElecPy = NONE; dElecPz = NONE; dElecE = NONE;
	dMuonPx; dMuonPy = NONE; dMuonPz = NONE; dMuonE = NONE;

	HiggsBJet1HiggsBJet2Dr = NONE; HiggsTopLepWNuDr = NONE; HiggsTopLepWLepDr = NONE; HiggsTopHadNonBJetDr = NONE; TopLepWLepTopHadNonBJetDr = NONE;
	TopLepTopHadDr = NONE; TopLepHiggsDr = NONE; TopHadHiggsDr = NONE; TopLepWTopLepBJetDr = NONE;
	TopLepWLepCharge = NONE;
	
	int Truth_idxTopLep = -1;
	int Truth_idxTopHad = -1;
	int Truth_idxTopLepBJet = -1;
	int Truth_idxTopHadNonBJet = -1;
	...
	for(int j=0;j<nplabel;j++)
	  {
	     ...
	     if( plab == 22 || plab == 32 ) Truth_idxTopHadNonBJet = j;
	...
	bool pass = (Truth_idxHiggsBJet1 >= 0 && Truth_idxTopLepBJet >= 0 &&
		     Truth_idxTopHadNonBJet >= 0 && Truth_idxTopLepWLep >= 0);

	if( !pass )
	  {
	     std::cout << "These are not TopTopLepHbb events" << std::endl;
	     ...
	     std::cout << "TopHadNonBJet=" << Truth_idxTopHadNonBJet << std::endl;
	...
	TopHadNonBJetPt = truth->at(0).mc_truth_pt()[Truth_idxTopHadNonBJet];
	TopHadNonBJetEta = truth->at(0).mc_truth_eta()[Truth_idxTopHadNonBJet];
	TopHadNonBJetPhi = truth->at(0).mc_truth_phi()[Truth_idxTopHadNonBJet];
	TopHadNonBJetE = truth->at(0).mc_truth_E()[Truth_idxTopHadNonBJet];
	...
	TLorentzVector *Truth_TopHadNonBJet = new TLorentzVector();
	Truth_TopHadNonBJet->SetPtEtaPhiE(TopHadNonBJetPt,TopHadNonBJetEta,TopHadNonBJetPhi,TopHadNonBJetE);
	...
	TLorentzVector *Rec_TopHadNonBJet = new TLorentzVector();
	...
	float drMinTopHadNonBJet = NONE;
	int idxMinTopHadNonBJet = -1;
	...
	for(int ij=0;ij<NJet;ij++)
	  {
	     ...
	     float drTopHadNonBJet = GetDeltaR(eta,phi,TopHadNonBJetEta,TopHadNonBJetPhi);
	     if( drTopHadNonBJet < drMinTopHadNonBJet && drTopHadNonBJet < 0.4 &&
		 fabs(pt-TopHadNonBJetPt)/std::max(pt,TopHadNonBJetPt) < 0.8 )
	       {
		  drMinTopHadNonBJet = drTopHadNonBJet;
		  idxMinTopHadNonBJet = ij;
	       }		  
	  }	     
	     
	TopHadNonBJetRecPt = (idxMinTopHadNonBJet >= 0) ? jets->at(idxMinTopHadNonBJet).pt() : NONE;
	TopHadNonBJetRecEta = (idxMinTopHadNonBJet >= 0) ? jets->at(idxMinTopHadNonBJet).eta() : NONE;
	TopHadNonBJetRecPhi = (idxMinTopHadNonBJet >= 0) ? jets->at(idxMinTopHadNonBJet).phi() : NONE;
	TopHadNonBJetRecE = (idxMinTopHadNonBJet >= 0) ? jets->at(idxMinTopHadNonBJet).E() : NONE;
	TopHadNonBJetRecCSVv2 = (idxMinTopHadNonBJet >= 0) ? jets->at(idxMinTopHadNonBJet).CSVv2() : NONE;

	if( idxMinTopHadNonBJet >= 0 )
	  Rec_TopHadNonBJet->SetPtEtaPhiE(TopHadNonBJetRecPt,
					  TopHadNonBJetRecEta,
					  TopHadNonBJetRecPhi,
					  TopHadNonBJetRecE);
	
	dTopHadNonBJetPx = (idxMinTopHadNonBJet >= 0) ? Truth_TopHadNonBJet->Px()-Rec_TopHadNonBJet->Px() : NONE;
	dTopHadNonBJetPy = (idxMinTopHadNonBJet >= 0) ? Truth_TopHadNonBJet->Py()-Rec_TopHadNonBJet->Py() : NONE;
	dTopHadNonBJetPz = (idxMinTopHadNonBJet >= 0) ? Truth_TopHadNonBJet->Pz()-Rec_TopHadNonBJet->Pz() : NONE;
	dTopHadNonBJetE = (idxMinTopHadNonBJet >= 0) ? Truth_TopHadNonBJet->E()-Rec_TopHadNonBJet->E() : NONE;
	...
	*Rec_TopHad = *Rec_Higgs+*Rec_TopHadNonBJet;
	if( idxMinHiggsBJet1 >= 0 && idxMinHiggsBJet2 >= 0 && idxMinTopHadNonBJet >= 0 )
	  {	     
	...
	HiggsTopHadNonBJetDr = GetDeltaR(HiggsEta,HiggsPhi,TopHadNonBJetEta,TopHadNonBJetPhi);
	TopLepWLepTopHadNonBJetDr = GetDeltaR(TopLepWLepEta,TopLepWLepPhi,TopHadNonBJetEta,TopHadNonBJetPhi);
	...
	TopHadHiggsDr = GetDeltaR(TopHadEta,TopHadPhi,HiggsEta,HiggsPhi);
	...
	for(int ij=0;ij<NJet;ij++)
	  {
	     ...
	     if( idxMinHiggsBJet1 != ij && idxMinHiggsBJet2 != ij &&
		 idxMinTopHadNonBJet != ij && idxMinTopLepBJet != ij )
	       {		  
