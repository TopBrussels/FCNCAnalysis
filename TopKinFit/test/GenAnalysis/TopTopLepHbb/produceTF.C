...
void produceTF()
{
   ...
   ch.SetBranchAddress("dTopHadNonBJetPx",&dTopHadNonBJetPx);
   ch.SetBranchAddress("dTopHadNonBJetPy",&dTopHadNonBJetPy);
   ch.SetBranchAddress("dTopHadNonBJetPz",&dTopHadNonBJetPz);
   ch.SetBranchAddress("dTopHadNonBJetE",&dTopHadNonBJetE);
	...
	for(int ih=0;ih<nHist;ih++)
	  {
	     ...
	     else if( hName[ih] == "dNonBJetPx" ) h[ih]->Fill(dTopHadNonBJetPx);
	     else if( hName[ih] == "dNonBJetPy" ) h[ih]->Fill(dTopHadNonBJetPy);
	     else if( hName[ih] == "dNonBJetPz" ) h[ih]->Fill(dTopHadNonBJetPz);
	     else if( hName[ih] == "dNonBJetE" ) h[ih]->Fill(dTopHadNonBJetE);
	  }	
     }
...
//	h[i]->GetYaxis()->SetTitle("Normalized to unity");
	...
	if( hName[i] == "dNonBJetPx" || hName[i] == "dNonBJetPy" || hName[i] == "dNonBJetPz" || hName[i] == "dNonBJetE" )
	  {
	     ...
	     funcGaus->SetParameter(6,1.);
	     funcGaus->SetParameter(7,mean);
	     funcGaus->SetParameter(8,sigma/4.);
	...
	if( hName[i] == "HiggsRecM" || hName[i] == "TopHadRecM" || hName[i] == "TopLepRecM" )
	  {
	     double mean = 125.;
	     double sigma = 10.;
