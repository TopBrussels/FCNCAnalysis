...
void drawGen()
{
   ...
   ch.SetBranchAddress("TopHadPt",&TopHadPt);
   ch.SetBranchAddress("TopHadEta",&TopHadEta);
   ch.SetBranchAddress("TopHadPhi",&TopHadPhi);
   ch.SetBranchAddress("TopHadE",&TopHadE);
   ...
   ch.SetBranchAddress("TopHadBJetPt",&TopHadBJetPt);
   ch.SetBranchAddress("TopHadBJetEta",&TopHadBJetEta);
   ch.SetBranchAddress("TopHadBJetPhi",&TopHadBJetPhi);
   ch.SetBranchAddress("TopHadBJetE",&TopHadBJetE);
   ch.SetBranchAddress("TopHadWNonBJet1Pt",&TopHadWNonBJet1Pt);
   ch.SetBranchAddress("TopHadWNonBJet1Eta",&TopHadWNonBJet1Eta);
   ch.SetBranchAddress("TopHadWNonBJet1Phi",&TopHadWNonBJet1Phi);
   ch.SetBranchAddress("TopHadWNonBJet1E",&TopHadWNonBJet1E);
   ch.SetBranchAddress("TopHadWNonBJet2Pt",&TopHadWNonBJet2Pt);
   ch.SetBranchAddress("TopHadWNonBJet2Eta",&TopHadWNonBJet2Eta);
   ch.SetBranchAddress("TopHadWNonBJet2Phi",&TopHadWNonBJet2Phi);
   ch.SetBranchAddress("TopHadWNonBJet2E",&TopHadWNonBJet2E);
   ...
   h[nHist] = new TH1D("h_GenTopHadPt","h_GenTopHadPt",50,0.,500.);
   h[nHist]->Sumw2();
   hName[nHist] = "GenTopHadPt";
   hLab[nHist] = "p_{T} [GeV]";
   nHist++;
   
   h[nHist] = new TH1D("h_GenTopHadEta","h_GenTopHadEta",50,-5.,5.);
   h[nHist]->Sumw2();
   hName[nHist] = "GenTopHadEta";
   hLab[nHist] = "#eta";
   nHist++;
   ...
   h[nHist] = new TH1D("h_GenTopHadBJetPt","h_GenTopHadBJetPt",50,0.,300.);
   h[nHist]->Sumw2();
   hName[nHist] = "GenTopHadBJetPt";
   hLab[nHist] = "p_{T} [GeV]";
   nHist++;
   
   h[nHist] = new TH1D("h_GenTopHadBJetEta","h_GenTopHadBJetEta",50,-5.,5.);
   h[nHist]->Sumw2();
   hName[nHist] = "GenTopHadBJetEta";
   hLab[nHist] = "#eta";
   nHist++;

   h[nHist] = new TH1D("h_GenTopHadWNonBJetPt","h_GenTopHadWNonBJetPt",50,0.,300.);
   h[nHist]->Sumw2();
   hName[nHist] = "GenTopHadWNonBJetPt";
   hLab[nHist] = "p_{T} [GeV]";
   nHist++;
   
   h[nHist] = new TH1D("h_GenTopHadWNonBJetEta","h_GenTopHadWNonBJetEta",50,-5.,5.);
   h[nHist]->Sumw2();
   hName[nHist] = "GenTopHadWNonBJetEta";
   hLab[nHist] = "#eta";
   nHist++;
   ...
   for(int i=0;i<nev;i++)
	...
	TLorentzVector TopHad; TopHad.SetPtEtaPhiE(TopHadPt,TopHadEta,TopHadPhi,TopHadE);
	...
	TLorentzVector TopHadBJet; TopHadBJet.SetPtEtaPhiE(TopHadBJetPt,TopHadBJetEta,TopHadBJetPhi,TopHadBJetE);
	TLorentzVector TopHadWNonBJet1; TopHadWNonBJet1.SetPtEtaPhiE(TopHadWNonBJet1Pt,TopHadWNonBJet1Eta,TopHadWNonBJet1Phi,TopHadWNonBJet1E);
	TLorentzVector TopHadWNonBJet2; TopHadWNonBJet2.SetPtEtaPhiE(TopHadWNonBJet2Pt,TopHadWNonBJet2Eta,TopHadWNonBJet2Phi,TopHadWNonBJet2E);
	
	for(int ih=0;ih<nHist;ih++)
	  {
	     if( hName[ih] == "GenTopLepPt" ) h[ih]->Fill(TopLepPt);
	     else if( hName[ih] == "GenTopLepEta" ) h[ih]->Fill(TopLepEta);
	     else if( hName[ih] == "GenTopHadPt" ) h[ih]->Fill(TopHadPt);
	     else if( hName[ih] == "GenTopHadEta" ) h[ih]->Fill(TopHadEta);
	     ...
	     else if( hName[ih] == "GenTopHadBJetPt" ) h[ih]->Fill(TopHadBJetPt);
	     else if( hName[ih] == "GenTopHadBJetEta" ) h[ih]->Fill(TopHadBJetEta);
	     else if( hName[ih] == "GenTopHadWNonBJetPt" ) {h[ih]->Fill(TopHadWNonBJet1Pt);h[ih]->Fill(TopHadWNonBJet2Pt);}
	     else if( hName[ih] == "GenTopHadWNonBJetEta" ) {h[ih]->Fill(TopHadWNonBJet1Eta);h[ih]->Fill(TopHadWNonBJet2Eta);}
	  }	
     }
